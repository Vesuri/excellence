...
public:
    ...
    static QImage quantize(const QImage &source, int num_colors, DitherMode mode = DitherMode::None, int outOf = 16777216, PaletteSortMode sortMode = PaletteSortMode::None, ProgressCallback progress = {});
};
